...
import '../../../authentication/presentation/view/login_page.dart';
import '../../../authentication/presentation/view_model/auth_view_model.dart';
import '../../../medical_diagnosis/data/models/result_model.dart';
import '../../../medical_diagnosis/data/repository/diagnosis_repository.dart';
...
class ResultViewModel extends GetxController {
  ...
  Future<void> getDiagnosisResults() async {
    ...
    if (accessToken == null) {
      ...
      result.fold(
        (error) => ErrorHandler.handleError(error as Failure),
